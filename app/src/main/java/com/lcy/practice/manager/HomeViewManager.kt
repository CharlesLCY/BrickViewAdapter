 ...
 * 15708478830@163.com
 **/
class HomeViewManager : com.lcy.brick.BaseBrickViewManager<User>() {
    ...
    override fun onBindVH(holder: com.lcy.brick.BrickViewHolder, count: Int, position: Int, data: User) {
